...
module.exports = {
  ...
  db: process.env.MONGODB|| 'mongodb://ragingflame:_Qawe01_@ds033828.mongolab.com:33828/devinbox',

  sessionSecret: process.env.SESSION_SECRET || 'ujksdfiossdfsjhe45353sdfsdfs',
